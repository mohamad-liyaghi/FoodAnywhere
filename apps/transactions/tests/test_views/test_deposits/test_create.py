...
class TestDepositCreateView:
    ...
    def test_create_more_than_three_pending_in_20_minutes_fails(self):
        self.client.force_authenticate(self.user)
        for _ in range(4):
        ...
        assert response.status_code == status.HTTP_403_FORBIDDEN
        assert response.data["detail"] == "You can't create more than 3 pending deposits in 20 minutes"
